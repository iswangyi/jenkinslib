         ...
         try {
            parallel(
                ...
                "build & deploy": {
                    ...
                    def image_name = "image.rightcloud.com.cn/${namespace}/rightcloud-resource:v.${branchname}.${arch_bz}.${env.BUILD_NUMBER}"
                    def image_name_huaweiyun = "swr.cn-east-3.myhuaweicloud.com/cmp/${namespace}/rightcloud-resource:v.${branchname}.${arch_bz}.${env.BUILD_NUMBER}"
