...
def call(isDeploy = true) {
    ...
    node {
        ...
        try {
            ...
            def image_name = "image.rightcloud.com.cn/${namespace}/bss-portal:v.${branchname}.${env.BUILD_NUMBER}"
            ...
            if (isDeploy && params.IS_DEPLOY == "true") {
                stageK8ServiceDeploy("portal", namespace, kubectl, image_name, false, "bss")
            }
