...
def call(isDeploy = true) {
    ...
    node {
        ...
        try {
            ...
            def image_name = "image.rightcloud.com.cn/${namespace}/bss-csdr-collector:v.${branchname}.${env.BUILD_NUMBER}"
            ...
            stage("build") {
                ...
                def  build_args = " --network=host --build-arg   PORTAL_PROJECT=./ "
                container('docker') {
            ...
            if (isDeploy) {
                stageK8ServiceDeploy("csdr-collector", namespace, kubectl, image_name, false, "bss")
            }
