...
//                },
                "build & deploy": {
                    ...
                    def image_name = "image.rightcloud.com.cn/${namespace}/rightcloud-monitor/${SERVER_OR_AGENT}:v.${branchname}.${arch_bz}.${env.BUILD_NUMBER}"
                    def image_name_huaweiyun = "swr.cn-east-3.myhuaweicloud.com/cmp/${namespace}/rightcloud-monitor/${SERVER_OR_AGENT}:v.${branchname}.${arch_bz}.${env.BUILD_NUMBER}"
                        ...
                        container('docker') {
                            dir("/home/jenkins/workspace/") {
                                ...
                                if (params.BUILD_CPU_ARCH=="ARM64"){
                                    ...
                                    sh "docker build -t ${image_name_huaweiyun} --no-cache -f app_component/monitor-${SERVER_OR_AGENT}/docker/${dockerfilename} . ${build_args}"
