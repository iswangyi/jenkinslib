         ...
         try {
            parallel(
                ...
                "build & deploy": {
                    ...
                    def amd64_image_name = "image.rightcloud.com.cn/${namespace}/rightcloud-operation-main:v.${branchname}.${arch_bz}.${env.BUILD_NUMBER}"
                    def amd64_image_name_huaweiyun = "swr.cn-east-3.myhuaweicloud.com/cmp/${namespace}/rightcloud-operation-main:v.${branchname}.${arch_bz}.${env.BUILD_NUMBER}"
                    def amd64_image_runtime = "image.rightcloud.com.cn/${namespace}/rightcloud-operation-runtime:v.${branchname}.${arch_bz}.${env.BUILD_NUMBER}"
                    def amd64_image_runtime_huaweiyun = "swr.cn-east-3.myhuaweicloud.com/cmp/${namespace}/rightcloud-operation-runtime:v.${branchname}.${arch_bz}.${env.BUILD_NUMBER}"
                    
                    def arm64_image_name = "image.rightcloud.com.cn/${namespace}/rightcloud-operation-main:v.${branchname}.${arch_bz}.${env.BUILD_NUMBER}"
                    def arm64_image_name_huaweiyun = "swr.cn-east-3.myhuaweicloud.com/cmp/${namespace}/rightcloud-operation-main:v.${branchname}.${arch_bz}.${env.BUILD_NUMBER}"
                    def arm64_image_runtime = "image.rightcloud.com.cn/${namespace}/rightcloud-operation-runtime:v.${branchname}.${arch_bz}.${env.BUILD_NUMBER}"
                    def arm64_image_runtime_huaweiyun = "swr.cn-east-3.myhuaweicloud.com/cmp/${namespace}/rightcloud-operation-runtime:v.${branchname}.${arch_bz}.${env.BUILD_NUMBER}"
                    ...
                    stage("builder") {
                        ...
                        def  build_args = " --network=host --build-arg   OPERATION_PROJECT=./app_component --build-arg PARENT_PROJECT=./parent  --build-arg COMPILER_IMAGE=swr.cn-east-3.myhuaweicloud.com/distroless/rightcloud-lib:4.2-jenkins "
