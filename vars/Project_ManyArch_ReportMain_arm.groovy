...
def call( isDeploy=false) {
    node {
        ...
        def arch_bz="kunpeng"
        if ("${arch_name}"=="feiteng"){1
            dockerfilename="Dockerfile.ft.light.arm"
            arch_bz="feiteng"
        }
         ...
         try {
            parallel(
                ...
                "build & deploy": {
                    ...
                    // def image_name = "image.rightcloud.com.cn/${namespace}/rightcloud-report-main:v.${branchname}.${arch_bz}.${env.BUILD_NUMBER}"
                    // def image_name_huaweiyun = "swr.cn-east-3.myhuaweicloud.com/cmp/${namespace}/rightcloud-report-main:v.${branchname}.${arch_bz}.${env.BUILD_NUMBER}"
                    // def image_runtime = "image.rightcloud.com.cn/${namespace}/rightcloud-report-runtime:v.${branchname}.${arch_bz}.${env.BUILD_NUMBER}"
                    // def image_runtime_huaweiyun = "swr.cn-east-3.myhuaweicloud.com/cmp/${namespace}/rightcloud-report-runtime:v.${branchname}.${arch_bz}.${env.BUILD_NUMBER}"



                    def branchname = "${PARAM_GIT_TAGS}"
                    def amd64_image_name = "image.rightcloud.com.cn/${namespace}/rightcloud-report-main:v.${branchname}.amd64.${env.BUILD_NUMBER}"
                    def amd64_image_name_huaweiyun = "swr.cn-east-3.myhuaweicloud.com/cmp/${namespace}/rightcloud-report-main:v.${branchname}.amd64.${env.BUILD_NUMBER}"
                    def amd64_image_runtime = "image.rightcloud.com.cn/${namespace}/rightcloud-report-runtime:v.${branchname}.amd64.${env.BUILD_NUMBER}"
                    def amd64_image_runtime_huaweiyun = "swr.cn-east-3.myhuaweicloud.com/cmp/${namespace}/rightcloud-report-runtime:v.${branchname}.amd64.${env.BUILD_NUMBER}"
                    
                    def arm64_image_name = "image.rightcloud.com.cn/${namespace}/rightcloud-report-main:v.${branchname}.arm64.${env.BUILD_NUMBER}"
                    def arm64_image_name_huaweiyun = "swr.cn-east-3.myhuaweicloud.com/cmp/${namespace}/rightcloud-report-main:v.${branchname}.arm64.${env.BUILD_NUMBER}"
                    def arm64_image_runtime = "image.rightcloud.com.cn/${namespace}/rightcloud-report-runtime:v.${branchname}.arm64.${env.BUILD_NUMBER}"
                    def arm64_image_runtime_huaweiyun = "swr.cn-east-3.myhuaweicloud.com/cmp/${namespace}/rightcloud-report-runtime:v.${branchname}.arm64.${env.BUILD_NUMBER}"
                    ...
                    stage("builder") {
                        ...
                        def  build_args = " --network=host --build-arg   IAM_PROJECT=./app_component --build-arg PARENT_PROJECT=./parent  --build-arg COMPILER_IMAGE=swr.cn-east-3.myhuaweicloud.com/distroless/rightcloud-lib:4.2-jenkins "
