         ...
         try {
            parallel(
                ...
                "build & deploy": {
                    ...
                    def runtime_image_name = "imagev2.rightcloud.com.cn/${namespace}/rightcloud-adapter-runtime:v.${branchname}.${env.BUILD_NUMBER}"
                    def image_name = "imagev2.rightcloud.com.cn/${namespace}/rightcloud-adapter:v.${branchname}.${env.BUILD_NUMBER}"
...
//                                sh "echo 'Success Build Image Tag: ${image_name}'"
                                  ...
                                  if (params.BUILD_CPU_ARCH=="ARM64"){
                                      ...
                                      sh "docker build -t ${runtime_image_name} --no-cache -f docker/Dockerfile.arm64 . ${build_args}"
