         ...
         try {
            parallel(
                ...
                "build & deploy": {
                    ...
                    def runtime_image_name = "imagev2.rightcloud.com.cn/${namespace}/rightcloud-report-runtime:v.${branchname}.${env.BUILD_NUMBER}"
                    def image_name = "imagev2.rightcloud.com.cn/${namespace}/rightcloud-report:v.${branchname}.${env.BUILD_NUMBER}"
                    ...
                    stage("builder") {
                        ...
                        def build_args = " --network=host --build-arg REPORT_PROJECT=./ "
