...
//    def kubectl = getKubectl(k8sEnv)
    ...
    node {
        ...
        try {
            ...
            def image_name = "image.rightcloud.com.cn/${namespace}/bss-console:v.${branchname}.${env.BUILD_NUMBER}"
            ...
            stage("build") {
                ...
                stage('build console image'){
                    ...
                    def  build_args = " --network=host --build-arg   CONSOLE_PROJECT=./ "
                    container('docker') {
            ...
            if (isDeploy && params.IS_DEPLOY == "true") {
                stageK8ServiceDeploy("bss-console", namespace, kubectl, image_name, false, 'bss')
            }
