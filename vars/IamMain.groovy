         ...
         try {
            // parallel(
                ...
                // "build & deploy": {
                    ...
                    def image_name = "image.rightcloud.com.cn/${namespace}/rightcloud-iam:v.${branchname}.${env.BUILD_NUMBER}"
                    ...
                    stage("build") {
                        ...
                        def build_args = " --build-arg IAM_PROJECT=./  "
                    ...
                    if (isDeploy) {
                        stageK8ServiceDeploy("iam", namespace, kubectl, image_name, false)
                    }
            //     }
            // )
         } catch (e) {
