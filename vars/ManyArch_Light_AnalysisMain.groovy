         ...
         try {
            parallel(
                ...
                "build & deploy": {
                    ...
                    def runtime_image_name = "imagev2.rightcloud.com.cn/${namespace}/rightcloud-analysis-runtime:v.${branchname}.${env.BUILD_NUMBER}"
                    def image_name = "imagev2.rightcloud.com.cn/${namespace}/rightcloud-analysis:v.${branchname}.${env.BUILD_NUMBER}"
